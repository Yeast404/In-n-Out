class BST<Key extends Comparable<? super Key>, E> implements Dictionary<Key, E> {
    ...
    private void printhelp(BSTNode<Key, E> rt, StringBuilder out, String padding, String pointer, boolean hasRightSibling) {
        if (rt == null) {
            return;
        }
        out.append("\n");
        ...
        String pointerForLeft = (rt.right() != null) ? "├──" : "└──";

        printhelp(rt.left(), out, paddingForBoth, pointerForLeft, rt.right() != null);
        printhelp(rt.right(), out, paddingForBoth, pointerForRight, false);
    }
    ...
    public String toString() {
        ...
        printhelp(root.left(), out, "", pointerLeft, root.right() != null);
        printhelp(root.right(), out, "", pointerRight, false);
        return out.toString();
    }
